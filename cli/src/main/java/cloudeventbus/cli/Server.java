...
public class Server {
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			new ServerBootstrap()
					...
					.childHandler(new ServerChannelInitializer(options.agent, trustStore))
	...
	private static class Options extends DefaultOptions {
		...
		@Parameter(names = "-agentName", description = "The name the server presents to clients that connect to it.")
		String agent = "eventbus-server";
